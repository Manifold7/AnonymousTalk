...
<script type = "text/javascript">
	...
	function accepttalk()
	{
		...
		xmlhttp.onreadystatechange=function()
  		{
  			if (xmlhttp.readyState==4 && xmlhttp.status==200)
    		{
				...
				for (var i=lines[0].length-1; i>-1; i--)
				{
						...
						if(lines[3][i]==1){
							document.getElementById("line").innerHTML +='<li><span class = "spanleft">'+str+'</span></li>';
						}
						else
						{
		...
		xmlhttp.open("GET","talk/accepttalk.php?room=1",true);
		xmlhttp.send();
	}
...
function onloadtalk(line){
	...
	xmlhttp.open("GET","talk/sendtalk.php?line="+line+"&room=1",true);
	xmlhttp.send();
...
<div id="container">  
            <div class="header">  
                <span style="float: left;">boy</span>  
                <span style="float: right;">gril</span>  
            </div>  
